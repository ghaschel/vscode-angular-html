...
const buildJson = (lang: Lang): PackageNls => {
  ...
  return {
    ...
    'ext.settings.html.ariaAttributeSuffix': `${json.settings.html.ariaAttributeSuffix}${markdown.settings.html.ariaAttributeSuffix}${json.settings.general.leaveEmpty}`,
    'ext.settings.html.dataAttributePrefix': `${json.settings.html.dataAttributePrefix}${markdown.settings.html.dataAttributePrefix}${json.settings.general.leaveEmpty}`,
    'ext.settings.html.dataAttributeSuffix': `${json.settings.html.dataAttributeSuffix}${markdown.settings.html.dataAttributeSuffix}${json.settings.general.leaveEmpty}`,
