...
const applyScopeColors = async (scopeColors: Scopes, debug: Debug): Promise<void> => {
  ...
  settings['vscode-angular-html.ngBootstrapElementTags'] = scopeColors[LegacyScopes.ngBootstrapElementTags];
  settings['vscode-angular-html.kendoUiElementTags'] = scopeColors[LegacyScopes.kendoUiElementTags];
